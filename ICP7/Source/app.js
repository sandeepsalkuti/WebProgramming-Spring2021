...
// const DB_USER = encodeURIComponent('sandeep');
// const PASSWORD = encodeURIComponent('Sunny@111'); 
mongoose.connect('mongodb+srv://root:root@cluster0.lpgnn.mongodb.net/mean-angular6?retryWrites=true&w=majority')
