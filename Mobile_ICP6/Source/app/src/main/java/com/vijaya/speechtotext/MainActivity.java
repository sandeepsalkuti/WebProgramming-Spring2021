...
public class MainActivity extends AppCompatActivity {
    ...
    private void recognition(String text){
        ...
        if(text.contains("hello")) {
            ...
            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:blue;\">Medical Assistant : What is your name ?</p>"));
        }
        if(text.contains("my name is"))
        {
            ...
            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:blue;\">Medical Assistant : Your name is"+preferences.getString(NAME,null)+"</p>"));
